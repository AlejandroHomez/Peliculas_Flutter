...
class Animation_CustomPainer_Linea extends StatefulWidget {
  final Movie movie;
  const Animation_CustomPainer_Linea(this.movie);

  @override
  State<Animation_CustomPainer_Linea> createState() =>
      _Animation_CustomPainerState();
}

class _Animation_CustomPainerState extends State<Animation_CustomPainer_Linea>
...
class _ProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradient = LinearGradient(
        ...
        colors: [MyColors.icon, Colors.blueAccent]);
